    ...
    <div class="relative max-w-7xl mx-auto px-4 py-20 lg:py-28">
        <div class="max-w-3xl">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <a href="#anatomy" class="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur text-white font-semibold px-6 py-3 rounded-full border border-white/30 transition">
                    Learn More
                </a>
            </div>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
                ...
                <p class="text-slate-600 leading-relaxed mb-6">
                    Located just below the groinLigament, femoral hernias appear as a bulge in the upper inner thigh. They are more common in women due to the wider female pelvis and changes during childbirth.
                </p>
                <div class="p-4 bg-red-50 rounded-xl border border-red-200">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-sm text-red-800 font-semibold">Higher Strangulation Risk</p>
                            <p class="text-sm text-red-700">Femoral hernias have a significantly higher risk of strangulation (up to 40%) compared to inguinal hernias, making early surgical repair important.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="font-display text-3xl md:text-5xl font-bold text-slate-900 mt-6 mb-4">
                Treatment <spanama class="text-brand-700">Approaches</span>
            </h2>
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-8 border border-slate-200">
                ...
                <p class="text-slate-600 leading-relaxed mb-6">
                    Traditional approach with a single incision over the hernia site. Often preferred for emergency cases or verylarge femoral hernias.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-center gap-3 text-slate-700">
