...
<section class="relative bg-gradient-to-br from-red-900 via-red-800 to-slate-900 text-white overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 py-20 lg:py-28">
        <div class="max-w-3xl">
            <span class="inline-flex items-center gap-2 bg-red-500/30 backdrop-blur px-4 py-2 rounded-full text-sm font-medium mb-6">
            ...
            <div class="flex flex-wrap gap-4">
                <a href="tel:<?= $site['phone_link'] ?>" class="inline-flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white font-semibold px-6 py-3 rounded-full transition animate-pulse">
...
<section class="py-16 md:py-24 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
                <span class="text-red-600 font-semibold uppercase tracking-wider text-sm">Understanding</span>
                ...
                <div class="p-4 bg-red-50 rounded-xl border border-red-200">
                    <div class="flex items-start gap-3">
                        <svg class="w-6 h-6 text-red-500 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M8.257 3.05c-1.311-1.523-3.636-1.07-4.708.967-1.071 2.038-.566 4.398.967 4.708L10 14.414l6.484-5.689c1.533-.31 2.037-2.67.967-4.708-1.07-2.038-3.396-2.49-4.708-.967L10 8.758 8.257 3.05zM10 18a8 8 0 100-16 8 8 0 000 16z" clip-rule="evenodd"/></svg>
                        <div>
                            <p class="text-sm text-red-800 font-semibold">Time is Critical</p>
                            <p class="text-sm text-red-700">Strangulation can lead to tissue death, bowel obstruction, sepsis, and death if not treated within 6 hours.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="font-display text-3xl md:text-5xl font-bold text-slate-900 mt-6 mb-4">
                Recognize the <span class="text-red-600">Warning Signs</span>
            </h2>
            <p class="text-slate-600 text-lg">Seek immediate medical help if you experience any of these symptoms.</p>
        </div>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-red-50 rounded-2xl p-6 border border-red-200 hover:shadow-lg transition">
            ...
            <div class="bg-red-50 rounded-2xl p-6 border border-red-200 hover:shadow-lg transition">
                <div class="w-12 h-12 rounded-xl bg-red-100 flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"/></svg>
                </div>
...
<section class="py-16 md:py-24 bg-gradient-to-br from-slate-900 via-red-900 to-slate-900 text-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="font-display text-3xl md:text-5xl font-bold mb-4">
                How to <span class="text-red-400">Prevent</span> Strangulation
            </h2>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-6">
                <div class="w-12 h-12 rounded-xl bg-green-500/20 flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
                </div>
