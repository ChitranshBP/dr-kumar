<?php
$page_title = 'Inguinal Hernia Treatment Doctor in Chennai | Dr. Kumar Billroth Hospitals';
$page_description = 'Looking for Inguinal Hernia treatment Doctor in Chennai? Consult Dr. Kumar Billroth Hospitals, a top groin hernia specialist, for advanced minimally invasive repairs.';
...
<section class="py-16 md:py-20 bg-brand-950 text-white text-center relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <a href="<?= $base_path ?>my_types/inguinal-hernia-surgery-in-chennai" class="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur text-white font-semibold px-8 py-4 rounded-full border border-white/30 transition hover:scale-105">
                Learn More
            </a>
        </div>
    </div>
