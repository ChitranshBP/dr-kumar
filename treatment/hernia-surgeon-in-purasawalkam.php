<?php
$page_title       = 'Hernia Surgeon in Purasawalkam | Dr. Kumar Billroth';
$page_description = 'Hernia treatment for Purasawalkam patients by Dr. Kumar at Billroth Hospitals, Shenoy Nagar. A short route through Kilpauk. Book a consultation today.';
$page_keywords    = 'hernia surgeon in Purasawalkam, hernia treatment Purasawalkam Chennai, hernia specialist near Purasawalkam, laparoscopic hernia surgery Purasawalkam, Dr. Kumar Billroth Hospitals';
            ...
            <article class="lg:col-span-8 bg-white rounded-3xl p-7 md:p-10 shadow-sm border border-slate-100">
                <div class="prose prose-slate max-w-none">
                    ...
                    <p class="text-slate-600 leading-relaxed mb-5">
                        Every hernia service Dr. Kumar offers is available to patients from Purasawalkam, since all consulting and surgery happens at the Shenoy Nagar hospital. Rather than repeat the clinical detail here, each is set out in full on its own page:
                    </p>
