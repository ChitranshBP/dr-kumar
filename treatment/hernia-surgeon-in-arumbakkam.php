<?php
$page_title       = 'Hernia Surgeon in Arumbakkam, Chennai | Dr. Kumar Billroth';
$page_description = 'Hernia treatment for Arumbakkam patients by Dr. Kumar at Billroth Hospitals, Shenoy Nagar. Direct Green Line metro to Shenoy Nagar. Book a consultation.';
$page_keywords    = 'hernia surgeon in Arumbakkam, hernia treatment Arumbakkam Chennai, hernia specialist near Arumbakkam, laparoscopic hernia surgery Arumbakkam, Dr. Kumar Billroth Hospitals';
$page_url         = 'https://herniacare360.com/treatment/hernia-surgeon-in-arumbakkam';

// This page serves the Arumbakkam catchment. The medical depth lives on the Chennai
...
$faqs = [
    ['q' => 'Is there a direct metro from Arumbakkam to the hospital?', 'a' => 'Yes. The Green Line runs from Arumbakkam through Koyambedu and Anna Nagar to Shenoy Nagar, the station nearest Billroth Hospitals.'],
    ['q' => 'How soon can hernia surgery be scheduled after the first consultation?', 'a' => 'It depends on your fitness for anesthesia and the tests needed. Straightforward cases are often scheduled within days rather than weeks.'],
    ['q' => 'Will I need mesh for my hernia repair?', 'a' => 'Most adult hernia repairs use mesh, because it reinforces the muscle gap and substantially lowers the chance of the hernia returning.'],
];
...
<section class="relative bg-brand-950 text-white overflow-hidden py-16 md:py-20">
    ...
    <div class="relative max-w-7xl mx-auto px-4 z-10">
        <nav class="flex items-center gap-2 text-sm text-slate-300 mb-6">
            ...
            <span class="text-slate-500">/</span>
            <span class="text-accent font-medium">Arumbakkam</span>
        </nav>

        <div class="max-w-3xl">
            <h1 class="font-display text-3xl md:text-5xl font-bold leading-tight mb-6">
                Hernia Surgeon in Arumbakkam,<br><span class="text-accent">Chennai</span>
            </h1>
            <p class="text-lg text-slate-200 leading-relaxed mb-8">
                Arumbakkam sits on the same Green Line as the hospital, so the metro replaces what would otherwise be a slow road journey across West Chennai.
            </p>
            ...
            <article class="lg:col-span-8 bg-white rounded-3xl p-7 md:p-10 shadow-sm border border-slate-100">
                <div class="prose prose-slate max-w-none">
                    ...
                    <p class="text-slate-600 leading-relaxed mb-5">
                        Every hernia service Dr. Kumar offers is available to patients from Arumbakkam, since all consulting and surgery happens at the Shenoy Nagar hospital. Rather than repeat the clinical detail here, each is set out in full on its own page:
                    </p>
                    ...
                    <!-- FAQ -->
                    <h2 class="font-display text-2xl md:text-3xl font-bold text-slate-900 mt-10 mb-5 border-b border-slate-100 pb-3">Arumbakkam Patient Questions</h2>
                    ...
                    <div class="bg-gradient-to-r from-brand-900 to-slate-900 text-white rounded-3xl p-7 text-center shadow-xl">
                        <h3 class="font-display text-xl md:text-2xl font-bold mb-3">Book a Hernia Consultation from Arumbakkam</h3>
