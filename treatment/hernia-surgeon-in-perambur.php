<?php
$page_title       = 'Hernia Surgeon in Perambur, Chennai | Dr. Kumar Billroth';
$page_description = 'Hernia treatment for Perambur patients by Dr. Kumar at Billroth Hospitals, Shenoy Nagar. Direct suburban rail from Perambur station. Book a consultation.';
$page_keywords    = 'hernia surgeon in Perambur, hernia treatment Perambur Chennai, hernia specialist near Perambur, laparoscopic hernia surgery Perambur, Dr. Kumar Billroth Hospitals';
$page_url         = 'https://herniacare360.com/treatment/hernia-surgeon-in-perambur';

// This page serves the Perambur catchment. The medical depth lives on the Chennai
...
$faqs = [
    ['q' => 'What is the easiest way to reach the hospital from Perambur?', 'a' => 'Take a suburban train from Perambur station to Chennai Central, then the Green Line metro to Shenoy Nagar, or travel by road through Kilpauk.'],
    ['q' => 'Does Dr. Kumar treat hernias in older patients?', 'a' => 'Yes. Age alone rarely rules out repair. Fitness for anesthesia matters more, and that is assessed before surgery is planned.'],
    ['q' => 'What happens if a hernia is left untreated?', 'a' => 'Most enlarge slowly over time. The main risk is tissue becoming trapped in the defect, which turns a planned keyhole operation into emergency surgery.'],
];
...
<section class="relative bg-brand-950 text-white overflow-hidden py-16 md:py-20">
    ...
    <div class="relative max-w-7xl mx-auto px-4 z-10">
        <nav class="flex items-center gap-2 text-sm text-slate-300 mb-6">
            ...
            <span class="text-slate-500">/</span>
            <span class="text-accent font-medium">Perambur</span>
        </nav>

        <div class="max-w-3xl">
            <h1 class="font-display text-3xl md:text-5xl font-bold leading-tight mb-6">
                Hernia Surgeon in Perambur,<br><span class="text-accent">Chennai</span>
            </h1>
            <p class="text-lg text-slate-200 leading-relaxed mb-8">
                Perambur has one of the best rail connections in this catchment, with a major suburban junction serving the neighborhood directly.
            </p>
                ...
                <div class="prose prose-slate max-w-none">
                    ...
                    <div class="bg-brand-50 border-l-4 border-brand-700 p-5 rounded-r-2xl mb-9">
                        <p class="text-slate-700 text-sm md:text-base leading-relaxed m-0">
                            <strong>Where to find Dr. Kumar:</strong> Billroth Hospitals, 43/18 Lakshmi Talkies Road, Shenoy Nagar, Chennai 600030. This is the single consulting and operating location, serving Perambur and the surrounding areas of Perambur Barracks Road, Jamalia, Sembiam and the Perambur station area.
                        </p>
                    </div>

                    <!-- Getting here: the genuinely local section -->
                    <h2 class="font-display text-2xl md:text-3xl font-bold text-slate-900 mb-4">Getting to Billroth Hospitals from Perambur</h2>
                    <p class="text-slate-600 leading-relaxed mb-5">Perambur railway station is a substantial junction with four platforms, served by the West, West North and West South lines of the Chennai Suburban Railway on the Chennai Beach and Central to Arakkonam section. For most Perambur patients the train is the fastest way into the city.</p>
                    <p class="text-slate-600 leading-relaxed mb-5">From Chennai Central you can change to the Green Line metro and travel up to Shenoy Nagar, or take an auto directly across through Kilpauk.</p>
                    <p class="text-slate-600 leading-relaxed mb-5">By road, Perambur connects through Sembiam and Konnur High Road toward Kilpauk. This is a slower route in the evenings, so a morning consultation slot generally works better from here.</p>

                    <!-- Care available -->
                    <h2 class="font-display text-2xl md:text-3xl font-bold text-slate-900 mt-9 mb-4 border-b border-slate-100 pb-3">Hernia Care Available to Perambur Patients</h2>
                    <p class="text-slate-600 leading-relaxed mb-5">
                        Every hernia service Dr. Kumar offers is available to patients from Perambur, since all consulting and surgery happens at the Shenoy Nagar hospital. Rather than repeat the clinical detail here, each is set out in full on its own page:
                    </p>
                    ...
                    <!-- FAQ -->
                    <h2 class="font-display text-2xl md:text-3xl font-bold text-slate-900 mt-10 mb-5 border-b border-slate-100 pb-3">Perambur Patient Questions</h2>
                    ...
                    <div class="bg-gradient-to-r from-brand-900 to-slate-900 text-white rounded-3xl p-7 text-center shadow-xl">
                        <h3 class="font-display text-xl md:text-2xl font-bold mb-3">Book a Hernia Consultation from Perambur</h3>
