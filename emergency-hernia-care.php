...
<section class="py-16 bg-slate-50">
    <div class="max-w-4xl mx-auto px-4">
        <div class="text-center mb-10">
            <h2 class="text-3xl font-bold text-slate-800 mb-4">Emergency FAQ</h2>
            <p class="text-slate-600">Common questions about hernia emergencies</p>
        </div>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                <button class="faq-toggle w-full text-left px-6 py-5 flex items-center justify-between gap-4 hover:bg-slate-50 transition">
                    <span class="font-semibold text-slate-800">How do I know if my hernia is strangulated?</span>
                ...
                <div class="faq-content hidden px-6 pb-5">
                    <p class="text-slate-600">Strangulation occurs when blood supply is cut off. Warning signs include: severe sudden pain, bulge that's hard and tender, skin redness or discoloration, fever, nausea/vomiting, and inability to pass gas. If you experience these, seek emergency care immediately.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                <button class="faq-toggle w-full text-left px-6 py-5 flex items-center justify-between gap-4 hover:bg-slate-50 transition">
                    <span class="font-semibold text-slate-800">Can I wait to see if symptoms improve?</span>
                    <svg class="faq-icon w-5 h-5 text-brand-600 shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                    </svg>
                </button>
                <div class="faq-content hidden px-6 pb-5">
                    <p class="text-slate-600">If you have emergency warning signs (severe pain, skin changes, fever, vomiting, firm bulge), do not wait. Contact us or go to the ER immediately. Tissue damage can occur within hours. For mild symptoms, you can schedule a regular appointment.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                <button class="faq-toggle w-full text-left px-6 py-5 flex items-center justify-between gap-4 hover:bg-slate-50 transition">
                    <span class="font-semibold text-slate-800">What information should I have ready when calling?</span>
                    <svg class="faq-icon w-5 h-5 text-brand-600 shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                    </svg>
                </button>
                <div class="faq-content hidden px-6 pb-5">
                    <p class="text-slate-600">Have ready: your name and contact details, description of symptoms and when they started, any fever readings, your current medications, and whether you've had previous hernia surgery. This helps us assess urgency and prepare for your arrival.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                <button class="faq-toggle w-full text-left px-6 py-5 flex items-center justify-between gap-4 hover:bg-slate-50 transition">
                    <span class="font-semibold text-slate-800">Is it safe to drive with hernia pain?</span>
                    <svg class="faq-icon w-5 h-5 text-brand-600 shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                    </svg>
                </button>
                <div class="faq-content hidden px-6 pb-5">
                    <p class="text-slate-600">If you have severe pain, suspected strangulation, or symptoms that could impair your driving, call for emergency transport or have someone else drive. Safety first - if you're unsure, call our emergency line for guidance.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                <button class="faq-toggle w-full text-left px-6 py-5 flex items-center justify-between gap-4 hover:bg-slate-50 transition">
                    <span class="font-semibold text-slate-800">What happens in emergency hernia surgery?</span>
                    <svg class="faq-icon w-5 h-5 text-brand-600 shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                    </svg>
                </button>
                <div class="faq-content hidden px-6 pb-5">
                    <p class="text-slate-600">Emergency hernia surgery typically involves releasing trapped tissue, checking for damage, repairing the hernia with mesh if appropriate, and possibly removing dead tissue. It's usually done under general anesthesia. Recovery may be longer than planned surgery but the goal is to prevent life-threatening complications.</p>
                </div>
            </div>
        </div>
    </div>
