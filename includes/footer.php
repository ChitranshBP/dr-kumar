    ...
    <div class="relative max-w-7xl mx-auto px-4 pt-16 pb-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
        ...
        <div class="lg:col-span-4">
            <div class="flex items-center gap-3 mb-5">
                <div class="w-14 h-14 rounded-xl bg-white p-1.5 shadow-lg shadow-brand-500/10 shrink-0">
                    <img src="<?= $base_path ?>assets/logo/hernia-final-logo.png" alt="Dr. Kumar Logo" class="w-full h-full object-contain">
                </div>
                <div>
                    <p class="text-white font-bold text-base leading-tight">Dr. Kumar</p>
                    <p class="text-brand-400 text-xs font-medium uppercase tracking-wider">Hernia Care 360</p>
                </div>
            </div>
        ...
        <div class="lg:col-span-3">
            ...
            <ul class="space-y-2.5 text-sm">
                ...
                <li><a href="<?= $base_path ?>special-considerations/pregnancy.php" class="group flex items-center gap-2 text-slate-400 hover:text-brand-400 transition-colors duration-200">
                    <svg class="w-3 h-3 text-brand-500/60 group-hover:text-brand-400 group-hover:translate-x-0.5 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
