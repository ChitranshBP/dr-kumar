    ...
    <div class="relative max-w-7xl mx-auto px-4 pt-16 pb-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
        ...
        <div class="lg:col-span-3">
            ...
            <ul class="space-y-3 text-[15px]">
                ...
                <li><a href="<?= $base_path ?>robotic-hernia-surgery.php" class="group flex items-center gap-2 text-slate-300 hover:text-white font-medium transition-colors duration-200">
                    <svg class="w-3 h-3 text-brand-500/60 group-hover:text-brand-400 group-hover:translate-x-0.5 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                    Robotic Surgery
                </a></li>
                ...
                <li><a href="<?= $base_path ?>treatment/mesh-repair.php" class="group flex items-center gap-2 text-slate-300 hover:text-white font-medium transition-colors duration-200">
                    <svg class="w-3 h-3 text-brand-500/60 group-hover:text-brand-400 group-hover:translate-x-0.5 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                    Mesh Repair
                </a></li>
    ...
    <div class="relative flex items-center justify-center max-w-md mx-auto px-2 py-2.5">
        <div class="flex items-center justify-between w-full gap-1">
            ...
            <a href="<?= $site['social']['facebook'] ?>" target="_blank" rel="noopener" class="group flex flex-col items-center gap-1 flex-1 py-1 rounded-xl hover:bg-slate-50 transition-all duration-200" aria-label="Facebook">
                <div class="relative w-10 h-10 rounded-2xl bg-[#1877F2] flex items-center justify-center shadow-sm shadow-[#1877F2]/30 group-hover:scale-110 group-active:scale-95 transition-transform duration-200">
                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12a10 10 0 10-11.6 9.9V14.9H7.9V12h2.5V9.8c0-2.5 1.5-3.9 3.8-3.9 1.1 0 2.2.2 2.2.2v2.5h-1.3c-1.2 0-1.6.8-1.6 1.6V12h2.7l-.4 2.9h-2.3V22A10 10 0 0022 12z"/></svg>
                </div>
