<?php
$page_title = 'What Causes a Hernia? Risk Factors & Prevention Tips | Dr. Kumar Billroth Hospitals';
    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div class="max-w-3xl">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <a href="symptoms" class="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 backdrop-blur text-white font-bold px-7 py-3.5 rounded-full border border-white/30 transition hover:scale-105">
                    View Symptoms
                </a>
            </div>
        </div>
