    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div class="max-w-3xl">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <a href="diagnosis.php" class="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 backdrop-blur text-white font-bold px-7 py-3.5 rounded-full border border-white/30 transition hover:scale-105">
                    Get Diagnosed
                </a>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative rounded-3xl overflow-hidden h-80 lg:h-96">
                <img src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800&q=80" alt="Medical emergency care" class="w-full h-full object-cover">
