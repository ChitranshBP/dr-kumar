...
<section class="relative bg-brand-950 text-white overflow-hidden py-20 md:py-28">
    <div class="max-w-7xl mx-auto px-4 relative z-10">
        <nav class="flex items-center gap-2 text-sm text-slate-300 mb-6 bg-white/5 backdrop-blur-sm px-4 py-2 rounded-full w-max border border-white/10">
            ...
            <span class="text-slate-500">/</span>
            <span class="text-accent font-medium">Symptoms</span>
        </nav>

        <div class="max-w-3xl">
            <h1 class="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] mb-6">
                Hernia <span class="text-accent">Symptoms</span>
            </h1>
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <a href="diagnosis" class="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 backdrop-blur text-white font-bold px-7 py-3.5 rounded-full border border-white/30 transition hover:scale-105">
                    Get Diagnosed
                </a>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div class="bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <p class="text-slate-600 text-sm">A lump or swelling in the groin or abdomen area, often more visible when standing or straining.</p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <p class="text-slate-600 text-sm">Aching, burning, or sharp pain that worsens with physical activity, heavy lifting, or prolonged standing.</p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 mb-2">Heaviness</h3>
                <p class="text-slate-600 text-sm">Feeling of dragging or heaviness in the groin or abdomen, as if something is weighing you down.</p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 mb-2">Straining Pain</h3>
                <p class="text-slate-600 text-sm">Discomfort when coughing, sneezing, or making bowel movements due to increased abdominal pressure.</p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <p class="text-slate-600 text-sm">Bulge may push back in or disappear when lying down. The hernia contents can be gently returned.</p>
            </div>

            <div class="bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="w-14 h-14 rounded-full bg-brand-100 flex items-center justify-center mb-4">
                    <svg class="w-7 h-7 text-brand-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg>
                </div>
                <h3 class="font-bold text-lg text-slate-900 mb-2">Growing Over Time</h3>
                <p class="text-slate-600 text-sm">The hernia gradually increases in size over weeks or months, indicating worsening condition.</p>
            </div>
        </div>
    </div>
</section>

<!-- Emergency Warning Section with Image -->
            ...
            <div>
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-4 p-4 bg-white rounded-xl border border-slate-200">
                        ...
                        <div>
                            <h4 class="font-semibold text-slate-900">Severe, Constant Pain</h4>
                            <p class="text-slate-500 text-sm">Sudden pain that doesn't go away and gets worse.</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4 p-4 bg-white rounded-xl border border-slate-200">
                        <div class="w-10 h-10 rounded-lg bg-brand-700 text-white flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <h4 class="font-semibold text-slate-900">Bulge Becomes Firm</h4>
                            <p class="text-slate-500 text-sm">The lump turns hard, tender, or cannot be pushed back in.</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4 p-4 bg-white rounded-xl border border-slate-200">
                        <div class="w-10 h-10 rounded-lg bg-brand-700 text-white flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <h4 class="font-semibold text-slate-900">Nausea or Vomiting</h4>
                            <p class="text-slate-500 text-sm">Digestive symptoms combined with a bulge need immediate evaluation.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="relative rounded-3xl overflow-hidden h-80 lg:h-96">
                <img src="<?= $base_path ?>assets/images/symptoms_emergency.png" alt="Medical emergency care" class="w-full h-full object-cover">
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div class="bg-slate-50 rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 rounded-full bg-brand-700 text-white font-bold text-lg flex items-center justify-center">1</div>
                    <h3 class="font-bold text-lg text-slate-900">Inguinal</h3>
                </div>
                <p class="text-slate-500 text-sm mb-3">Groin, inner thigh</p>
                <ul class="space-y-2 text-sm text-slate-600">
                    <li class="flex items-start gap-2">
                        ...
                        <span>Visible bulge in groin</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-brand-600 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                        <span>Pain may extend to testicles</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-slate-50 rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 rounded-full bg-brand-700 text-white font-bold text-lg flex items-center justify-center">2</div>
                    <h3 class="font-bold text-lg text-slate-900">Umbilical</h3>
                </div>
                <p class="text-slate-500 text-sm mb-3">Belly button area</p>
                <ul class="space-y-2 text-sm text-slate-600">
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-brand-600 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                        <span>Visible bulge at navel</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-brand-600 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                        <span>Often painless</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-slate-50 rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 rounded-full bg-brand-700 text-white font-bold text-lg flex items-center justify-center">3</div>
                    <h3 class="font-bold text-lg text-slate-900">Incisional</h3>
                </div>
                <p class="text-slate-500 text-sm mb-3">Previous surgical scar</p>
                <ul class="space-y-2 text-sm text-slate-600">
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-brand-600 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                        <span>Bulge at incision site</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-brand-600 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                        <span>May have numbness around scar</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-slate-50 rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 rounded-full bg-brand-700 text-white font-bold text-lg flex items-center justify-center">4</div>
                    <h3 class="font-bold text-lg text-slate-900">Hiatal</h3>
                </div>
                <p class="text-slate-500 text-sm mb-3">Internal (chest area)</p>
                <ul class="space-y-2 text-sm text-slate-600">
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-brand-600 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                        <span>Heartburn and acid reflux</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-brand-600 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                        <span>Chest pain, difficulty swallowing</span>
                    </li>
                </ul>
            </div>
        </div>
...
<section class="py-16 bg-brand-950 text-white">
    <div class="max-w-4xl mx-auto px-4 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <a href="diagnosis" class="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur text-white font-bold px-8 py-4 rounded-full border border-white/30 transition hover:scale-105">
...
<section class="py-8 bg-white border-t border-slate-100">
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex flex-wrap gap-3 justify-center">
            <a href="what-is-hernia" class="px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-full text-sm font-medium transition">What is Hernia</a>
